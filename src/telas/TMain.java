...
public class TMain extends JFrame {
	...
	private void initComponents() {
		final java.awt.Color tableColor = new java.awt.Color(46,46,46);
		final java.awt.Color textColor = new java.awt.Color(46,52,64);
		final java.awt.Color buttonColor = new java.awt.Color(143,188,187);
		// ImageIcon img = new ImageIcon("../images/plane.svg");
		...
		btnRemove.setForeground(textColor);
		btnRemove.setText("Remover");
		btnRemove.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
		...
		pnlRadar = new JPanel();
		pnlRadar.setBackground(tableColor);
		pnlRadar.setPreferredSize(new java.awt.Dimension(300, 300));

		pnlRadar.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
		...
		btnScale.setBackground(buttonColor);
		btnScale.setForeground(textColor);
		btnScale.setText("Escalonar");
		btnScale.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
		...
		btnTranslate.setForeground(textColor);
		btnTranslate.setText("Transladar");
		btnTranslate.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
		...
		btnRotate.setBackground(buttonColor);
		btnRotate.setForeground(textColor);
		btnRotate.setText("Rotacionar");
		btnRotate.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
		...
		btnDistAirport.setBackground(buttonColor);
		btnDistAirport.setForeground(textColor);
		btnDistAirport.setText("Aeroporto");
		btnDistAirport.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
		...
		btnDistPlanes.setBackground(buttonColor);
		btnDistPlanes.setForeground(textColor);
		btnDistPlanes.setText("Distância do Avião");
		btnDistPlanes.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
		...
		btnCollisionCourse.setBackground(buttonColor);
		btnCollisionCourse.setForeground(textColor);
		btnCollisionCourse.setText("Em rota de Colisão");
		btnCollisionCourse.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_ROUND_RECT);
