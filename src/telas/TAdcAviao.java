...
public class TAdcAviao extends JDialog {
	...
	private JRadioButton rdbCartesiano;
	...
	public TAdcAviao(TMain p) {
		...
		lblTitle.setIcon(new ImageIcon(TAdcAviao.class.getResource("/images/plane.png")));
		lblTitle.setFont(new Font("Malgun Gothic Semilight", Font.BOLD, 20));

		rdbCartesiano = new JRadioButton("Cartesiano");
		rdbCartesiano.setSelected(true);
		rdbCartesiano.setFont(new Font("Arial", Font.PLAIN, 16));

		rdbPolar = new JRadioButton("Polar");
		rdbPolar.setFont(new Font("Arial", Font.PLAIN, 16));

		grpRdbButtons = new ButtonGroup();
		grpRdbButtons.add(rdbCartesiano);
		...
		rdbCartesiano.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				habilitaCartesiano();
			}
		});
	...
	private void habilitaCartesiano() {
